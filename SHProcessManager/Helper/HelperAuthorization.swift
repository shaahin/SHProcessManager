...
class HelperAuthorization {
    ...
    static let authorizationRights = [
        HelperAuthorizationRight(command: #selector(HelperProtocol.killProcess(withPID:authData:completion:)),
                                 description: "SHProcessManagerHelper wants to run the command kill",
